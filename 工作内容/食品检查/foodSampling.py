...
def left_info():
    ...
    page_text = driver.find_element_by_xpath('//div[@id="pager"]//li[@class="ng-scope"][1]/span').get_attribute('textContent')
        ...
        for x in range(1, 11):
            ...
            if int(count) > 10:  # 判断详情页页数
                ...
                for num in range(int(count)):
                    text = driver.find_element_by_xpath('//*[@class="t_data"]/tr[' + str(num + 1) + ']').get_attribute('textContent')
