...
cookies = {
    ...
    'ASP.NET_SessionId': '0sqau05vreavmg1d5m001kcg',
    'MobilePhone': '18731341598',
    'LoginName': '18731341598',
    'CNZZDATA1275790483': '896244566-1626657114-%7C1626667923',
}
...
response = requests.post('https://cprs.patentstar.com.cn/Search/SearchByQuery', headers=headers, cookies=cookies, data=data, proxies=get_proxies())
print(response.text)
