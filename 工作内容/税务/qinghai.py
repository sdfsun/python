...
def getInfo(i):
    ...
    time.sleep(1)
    driver.find_element_by_xpath('//*[@id="searchTable"]/div[10]/input[1]').click()
    time.sleep(1)
    try:
        driver.find_element_by_xpath('//*[@id="cxlist"]/ul['+str(i)+']/li[1]/a').click()
        time.sleep(1)
        all_h=driver.window_handles
        driver.switch_to.window(all_h[1])
        info=driver.find_element_by_xpath('//*[@id="main"]/ucapcontent/table/tbody').get_attribute('innerHTML')
        #print(info)
